...
var LDAvis = function(to_select, data_or_file_name) {
    ...
    var K, // number of topics
        ...
        color1 = "#515892", // baseline color for default topic circles and overall term frequencies
    ...
    function visualize(data) {
        ...
        function init_forms(topicID, lambdaID, visID) {
            ...
            topicDiv.setAttribute("style", "padding: 5px; background-color: #e8e8e8; display: inline-block; width: " + mdswidth + "px; height: 50px; float: left; border-radius: 3px");
            ...
            lambdaDiv.setAttribute("style", "padding: 5px; background-color: #e8e8e8; display: inline-block; height: 50px; width: " + lambdaDivWidth + "px; float: right; margin-right: 30px; border-radius: 3px");
