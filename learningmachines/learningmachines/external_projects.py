...
PROJECTS = {
	...
	"Hathi_Anthro" : {
		...
		"image" : "",
		"Links" : [["https://vis.modelofmodels.io/lda/vis?method=hdsr&model=full_pages&num_topics=40&tfidf=False&passes=20&corpus=HathiTrust&level_select=article&dn=710,790&nodesize=docs", "All pages as docs: 710,790 pages"],
			["https://vis.modelofmodels.io/lda/vis?method=hdsr&model=page_climate_post_1945&num_topics=40&tfidf=False&passes=20&corpus=HathiTrust&level_select=article&dn=28,831&nodesize=docs", 'Post-1945 Climate: 28,831 pages'],
			["https://vis.modelofmodels.io/lda/vis?method=hdsr&model=page_climate_pre_1945&num_topics=40&tfidf=False&passes=20&corpus=HathiTrust&level_select=article&dn=6,831&nodesize=docs", 'Pre-1945 Climate: 6,831 pages']]
...
#https://ucdscenter.github.io/climate_race_maps

#/searcher/projects/?name=vent_notes

#/searcher/projects/?name=vent_notes&sample=True


#https://vis.modelofmodels.io/lda/vis?method=hdsr&model=full_pages&num_topics=40&tfidf=False&passes=20&corpus=HathiTrust&level_select=article&dn=710,790&nodesize=docs

#https://vis.modelofmodels.io/lda/vis?method=hdsr&model=page_climate_post_1945&num_topics=40&tfidf=False&passes=20&corpus=HathiTrust&level_select=article&dn=28,831&nodesize=docs

#https://vis.modelofmodels.io/lda/vis?method=hdsr&model=page_climate_pre_1945&num_topics=40&tfidf=False&passes=20&corpus=HathiTrust&level_select=article&dn=6,831&nodesize=docs
