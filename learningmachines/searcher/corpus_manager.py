...
class CorpusManager:
	...
	def create_ngrams(self, n=3, show=False):
		...
		bigram = Phrases(es_iter, min_count=1, threshold=100, max_vocab_size=150000) # higher threshold fewer phrases.
		if n > 2:
			trigram = Phrases(bigram[es_iter], min_count=1, threshold=100, max_vocab_size=150000)
